...
CREATE TABLE IF NOT EXISTS 10_AgenciaSeguros_polizas (
    ...
    observaciones TEXT,
    FOREIGN KEY (cliente_id) REFERENCES 10_AgenciaSeguros_clientes(id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS 10_AgenciaSeguros_pagos (
    ...
    fecha DATE NOT NULL,
    importe DECIMAL(10, 2) NOT NULL,
    FOREIGN KEY (poliza_id) REFERENCES 10_AgenciaSeguros_polizas(id) ON DELETE CASCADE
);
