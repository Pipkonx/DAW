...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-11-2025 a las 11:25:57
...
(1, '67716376B', 'Raúl Medina', '+34 688343386', 'raúl.medina@example.com', 'Tarea de mantenimiento #1', 'Calle Falsa 99', 'Málaga', '37852', '41', 'R', 'Carlos Ruiz', '2025-11-21', 'Nota anterior 1', 'Nota posterior 1'),
...
VALUES (
        ...
        'admin',
        'admin',
        '7XMCvZkfVMHA2i5xmjF5GdrWHt7iuDPVGKCMan7A',
        0,
        'admin'
    ),
    (
