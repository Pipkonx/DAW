...
abstract class C_Controller
{
     ...
     */
    protected function getPaginationData(object $modelo, int $perPage, ?string $countMethod = null, $countParam = null): array
    {
        ...
        $totalPaginas = (int) max(1, ceil($totalElementos / $perPage));
