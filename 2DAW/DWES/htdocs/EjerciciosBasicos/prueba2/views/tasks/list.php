...
<?php if (($_GET['role'] ?? 'operador') !== 'admin' && !empty($currentUser)): ?>
    <a href="index.php?controller=User&action=edit&id=<?= $currentUser['id'] ?>&role=operador&user=<?= htmlspecialchars($_GET['user'] ?? '') ?>" class="btn btn-outline-secondary mb-3">Editar perfil</a>
<?php endif; ?>
