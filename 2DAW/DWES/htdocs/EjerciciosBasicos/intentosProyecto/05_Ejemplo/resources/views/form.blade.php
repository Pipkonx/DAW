<div class="form-container">
    <form action="{{ $formActionUrl }}" method="POST" enctype="multipart/form-data">
        ...
        <select name="operarioEncargado">
            ...
            <option value="Ana María Fernández" <?= $operarioEncargado == "Ana María Fernández" ? "selected" : "" ?>>Ana
                María
                Fernández</option>
            <option value="Sara Martínez" <?= $operarioEncargado == "Sara Martínez" ? "selected" : "" ?>>Sara Martínez
            </option>
            <option value="Lucía Hurtado" <?= $operarioEncargado == "Lucía Hurtado" ? "selected" : "" ?>>Lucía Hurtado
            </option>
        </select><br><br>
        ...
        <textarea id="anotacionesAnteriores"
            name="anotacionesAnteriores"><?= htmlspecialchars($anotacionesAnteriores) ?></textarea><br><br>
        ...
        <a class="btn btn-cancel" href="/EjerciciosBasicos/intentosProyecto/05_Ejemplo/public/tareas">Cancelar</a>
