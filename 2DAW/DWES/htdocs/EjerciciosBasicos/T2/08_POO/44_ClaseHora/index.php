...
//! DUDA : NO ME CARGA EL REQUIRE DE LA CLASE HORA, EN EL DOCUMENTO YA PUSE LAS FUNCIONES INDICADAS EN ESTE DOCUMENTO
// require '../../ClaseHora/index.php';
require_once '../ClaseHora/index.php';
...
while ($horaActual->esMenor($horaFin)) {
    ...
    echo "<td>" . $tareas[$indiceTarea] . "</td></tr>";
