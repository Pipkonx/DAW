...
|--------------------------------------------------------------------------
| Un "Closure" es una función anónima que se utiliza aquí para gestionar 
| el flujo de la petición, permitiendo que Laravel continúe hacia el 
| siguiente middleware tras validar los permisos ($next).
*/
use Closure;
